...
#pragma pack(pop)
    ...
    const DDS_PIXELFORMAT DDSPF_G16R16 = { sizeof(DDS_PIXELFORMAT), DDS_RGB, 0, 32, 0x0000ffff, 0xffff0000, 0, 0 };
    ...
    const DDS_PIXELFORMAT DDSPF_X8L8V8U8 = { sizeof(DDS_PIXELFORMAT), DDS_BUMPLUMINANCE, 0, 32, 0x000000ff, 0x0000ff00, 0x00ff0000, 0 };

    // Note these 10:10:10:2 format RGB masks are reversed to support a long-standing bug in D3DX
    const DDS_PIXELFORMAT DDSPF_A2R10G10B10 = { sizeof(DDS_PIXELFORMAT), DDS_RGBA, 0, 32, 0x000003ff, 0x000ffc00, 0x3ff00000, 0xc0000000 };
    const DDS_PIXELFORMAT DDSPF_A2B10G10R10 = { sizeof(DDS_PIXELFORMAT), DDS_RGBA, 0, 32, 0x3ff00000, 0x000ffc00, 0x000003ff, 0xc0000000 };
    ...
    {
    public:
        auto_delete_file_wic(ComPtr<IWICStream>& hFile, const wchar_t* szFile) noexcept
            : m_filename(szFile),
              m_handle(hFile)
        {}
    ...
    size_t BitsPerPixel(_In_ D3DFORMAT fmt) noexcept
    {
        ...
        case MAKEFOURCC('I', 'A', '4', '4'): return 8;
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_ HRESULT DirectX::SaveDDSTextureToFile(LPDIRECT3DSURFACE9 pSource, const wchar_t* fileName) noexcept
{
    if (!pSource || !fileName)
        return E_INVALIDARG;
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_ HRESULT DirectX::SaveWICTextureToFile(LPDIRECT3DSURFACE9 pSource,
    ...
    std::function<void(IPropertyBag2*)>                                         setCustomProps)
{
    ...
    else
    {
        ...
        case D3DFMT_A1R5G5B5:
        case D3DFMT_X1R5G5B5:     targetGuid = GUID_WICPixelFormat16bppBGR555; break;

        case D3DFMT_L16:          targetGuid = GUID_WICPixelFormat16bppGray; break;

        case D3DFMT_R32F:
        case D3DFMT_R16F:
        case D3DFMT_L8:           targetGuid = GUID_WICPixelFormat8bppGray; break;

        default:                  targetGuid = GUID_WICPixelFormat24bppBGR; break;
        }
    }
    ...
    if (memcmp(&targetGuid, &pfGuid, sizeof(WICPixelFormatGUID)) != 0)
    {
        ...
        hr = pWIC->CreateBitmapFromMemory(desc.Width,
            desc.Height,
            pfGuid,
